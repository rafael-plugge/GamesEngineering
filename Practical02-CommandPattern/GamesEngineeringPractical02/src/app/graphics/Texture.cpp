...
app::graphics::Texture::Texture(app::util::UPtrRenderer const & renderer, std::string const & file)
	: m_texture(nullptr)
{
	this->loadTexture(renderer, file);
}

bool app::graphics::Texture::loadTexture(app::util::UPtrRenderer const & renderer, std::string const & file)
{
...
app::util::UPtrTexture app::graphics::Texture::loadTextureFromFile(app::util::UPtrRenderer const & renderer, std::string const & file)
{
...
app::util::UPtrSurface app::graphics::Texture::loadSurfaceFromFile(std::string const & file)
{
