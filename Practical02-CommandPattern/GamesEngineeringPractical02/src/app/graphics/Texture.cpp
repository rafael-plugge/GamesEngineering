...
app::gra::Texture::Texture(app::util::UPtrRenderer const & renderer, std::string const & file)
	: m_texture(nullptr)
{
	this->loadTexture(renderer, file);
}

bool app::gra::Texture::loadTexture(app::util::UPtrRenderer const & renderer, std::string const & file)
{
...
app::util::UPtrTexture app::gra::Texture::loadTextureFromFile(app::util::UPtrRenderer const & renderer, std::string const & file)
{
